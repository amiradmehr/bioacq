...
- Built from `main` at commit 25620e7 by the Windows GitHub Actions workflow (MSVC 2022, Qt 6, BrainFlow 5.23.0 patched), Windows 10/11 x64. The Visual C++ runtime is included.
